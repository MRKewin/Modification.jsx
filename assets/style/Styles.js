...
export default StyleSheet.create({
    ...
    container2: { flex: 2, height:'100%', width:'100%', top:10},
    ...
    textTitleWhite: { color: '#fff', fontSize: 18, fontFamily:'Comfortaa-Bold', },

    textTitleWhite2: { color: '#fff', fontSize: 18, fontFamily:'Comfortaa-Bold', },

    textTitleWhite3: { color: '#fff', fontSize: 18, textAlign:'center', fontFamily:'Comfortaa-Bold', },

    textWhite: { color: '#fff', fontSize: 16, fontFamily: 'Comfortaa-Bold', },

    textWhite2: { color: '#fff', fontSize: 14, width: '90%', height: 200, fontFamily: 'Comfortaa-Regular', },
    
    textWhite3: { color: '#fff', fontSize: 16, width: "90%", alignSelf: "center", fontFamily: 'Comfortaa-Regular', },

    textWhite4: { color: '#fff', fontSize: 16, alignSelf: "center", fontFamily: 'Comfortaa-Regular', },
    
    textWhite5: { color: '#fff', fontSize: 16, width: '80%', height: 280, alignSelf: "center", fontFamily: 'Comfortaa-Regular',},

    textWhite6: { color: '#fff', fontSize: 16, fontFamily: 'Comfortaa-Regular', },
    
    textWhite7: { color: '#fff', fontSize: 16, width: '80%', height: 350, alignSelf: "center", fontFamily: 'Comfortaa-Regular', },
    
    textWhite8: { color: '#fff', fontSize: 16, width: '70%', height: 350, alignSelf: "center", fontFamily: 'Comfortaa-Regular', },
    
    textError: { color: '#880808', width: '70%', fontSize: 14, alignSelf: "center", textDecorationLine: 'underline', textDecorationColor: 'red', fontFamily: 'Comfortaa-Bold', },

    textError2: { color: '#880808', width: '80%', fontSize: 14, alignSelf: "center", textDecorationLine: 'underline', textDecorationColor: 'red', fontFamily: 'Comfortaa-Bold', },
    
    textWhiteCenter: { color: '#fff', textAlign: 'center', fontFamily: 'Comfortaa-Regular', fontSize: 20, },
    
    textWhiteCenter2: { color: '#fff', fontSize: 14, width: "75%", alignSelf: "center", fontFamily: 'Comfortaa-Regular', textAlign: 'center', },
    
    textGrayCenter: { color: '#cacaca', textAlign: 'center', fontFamily: 'Comfortaa-Regular', fontSize: 20, },
    
    textRed: { color: '#A70000', width: '80%', fontSize: 16, textDecorationLine: 'underline', fontFamily: 'Comfortaa-Regular', textAlign: 'center', alignSelf: 'center', },
    
    textBlue: { width: '80%', color: '#0F0BAE', fontSize: 18, fontFamily: 'Comfortaa-Regular', textAlign: 'left', alignSelf: 'center', },
    
    textBlue2: {  width: '80%', color: '#0F0BAE', fontSize: 14, fontFamily: 'Comfortaa-Bold', textAlign: 'left', alignSelf: 'center',},

    textBlue3: { width: '80%', color: '#0F0BAE', fontSize: 14, textAlign: 'center', fontFamily: 'Comfortaa-Bold', alignSelf: 'center', },
    
    textBlue4: { width: '80%', color: '#0F0BAE', fontSize: 14, textAlign: 'left', fontFamily: 'Comfortaa-Bold', alignSelf: 'center', },
    
    textBlueBold: { color: '#0F0BAE', fontSize: 16, fontWeight: 800, fontFamily: 'Comfortaa-Regular',},

    textBlueCenter: { color: '#0F0BAE', fontSize: 16, fontFamily: 'Comfortaa-Regular', alignSelf: 'center',},

    textBlueCenter2: { color: '#0F0BAE', fontSize: 16, fontFamily: 'Comfortaa-Regular', alignSelf: 'center', textAlign: 'center', fontWeight: 800, },

    textBlueCenter3: { color: '#0F0BAE', fontSize: 16, fontFamily: 'Comfortaa-Regular', alignSelf: 'center', textAlign: 'center',},

    textBlack: { color: '#000', fontSize: 16, fontFamily: 'Comfortaa-Regular', alignSelf: 'center', },
    
    textBlack2: { color: '#000', fontSize: 14, fontFamily: 'Comfortaa-Bold', textAlign: 'left',},

    textBlackBold: { color: '#000', fontSize: 16, fontFamily: 'Comfortaa-Bold', textAlign:'center', },
    
    textBlackBold2: { color: '#000', fontSize: 16, fontFamily: 'Comfortaa-Bold', textAlign:'center',},

    textWhiteRound: { color: '#fff', textAlign: 'center', fontFamily: 'Comfortaa-Regular', width: '80%', padding: 12, height: 50, alignSelf: 'center', fontSize: 18, borderWidth: 2, borderColor: '#fff', borderRadius: 20,},
    ...
    btn2: { width: 311, height: 56, resizeMode: 'contain', alignSelf:'center' },
    ...
    textBtn: { color: '#fff', fontSize: 18, textAlign: 'center', alignSelf: 'center', fontFamily:'Comfortaa-Bold' },
    ...
    textBtnBlue: { color: '#0F0BAE', width: '80%', fontSize: 18, textAlign: 'center', alignSelf: 'center', textDecorationLine: 'underline', },
    
    textBtnBlue2: { color: '#0F0BAE', width: '80%', fontSize: 14, textAlign: 'left', textDecorationLine: 'underline', },

    textBtnBlue3: { color: '#0F0BAE', fontSize: 18, textAlign: 'center', textDecorationLine: 'none', },
    
    textBtn2: { color: '#fff', fontSize: 18, textDecorationLine: 'underline', textAlign: 'center', },
    
    textBtn3: { color: "#fff", fontSize: 18, textAlign: "center", alignSelf:'flex-end', marginRight:60, textDecorationLine:'underline', fontFamily:'Comfortaa-Bold'},
    
    textBtn4: { color: "#fff", fontSize: 18, textAlign: "center", textDecorationLine:'underline', fontFamily:'Comfortaa-Regular', },
    
    textBtn5: { color: '#000', fontSize: 18, textAlign: 'center', },
    
    textBtn6: { color: '#fff', fontSize: 18, textAlign: 'center', fontFamily:'Comfortaa-Regular', },
    
    textBtn7: { color: '#fff', fontSize: 18, textAlign: 'left', },
    
    textBtn8: { color: '#fff', fontSize: 18, width: '80%', textDecorationLine: 'underline', alignSelf: 'center', textAlign:'center', },
    
    textBtn9: { color: '#0F0BAE', fontSize: 18, textAlign: 'center', fontFamily: 'Comfortaa-Regular', },
    
    textBtn10: { color: '#fff', fontSize: 18, textAlign: 'center', fontFamily:'Comfortaa-Regular', },

    textBtnModal: { color: '#0F0BAE', backgroundColor: '#fff', width: 100, height: 40, padding: 12, fontSize: 18, textAlign: "center", borderWidth: 3, borderColor: '#0F0BAE', borderRadius: 30, alignSelf: 'center',},
    ...
    imgCard2: { width: 100, height: 50, alignSelf: 'center', margin: 5, resizeMode:'contain' },
    ...
    barreScrollBtn: { backgroundColor: '#FFF', top: -105, height: 100, left: 287, width: 4, },

    ScrollBtnDown: { left: 280, top: -120, },
    
    ScrollBtnUp: { left: 280,top: 30,},
